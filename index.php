...
<!-- Testimonial Section -->
<section class="py-16 md:py-24 bg-cover bg-center relative" style="background-image: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('/Bonsai/Images/Index/tree-dark-background.jpg');">
